...
const ModernTemplate: React.FC<ModernTemplateProps> = ({ user, layoutMaxWidth, socialIcons, getColorFromIcon, formatJoinedAt, getEffectClass, sortedWidgets, previewTemplate }) => {
    const effect = getEffectClass(user.profile.username_effects);
    console.log(effect, user.profile.username_effects)
    const threshold = 690;
            ...
            <Client3DWrapper enable3DHover={user?.profile?.parallax_effect} layoutMaxWidth={layoutMaxWidth}>
                ...
                >
                    ...
                    >
                        ...
                        {/* Divider after views if location exists */}
