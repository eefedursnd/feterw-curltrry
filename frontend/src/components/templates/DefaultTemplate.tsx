...
const DefaultTemplate: React.FC<DefaultTemplateProps> = ({ user, layoutMaxWidth, socialIcons, getColorFromIcon, formatJoinedAt, getEffectClass, sortedWidgets, previewTemplate }) => {
            ...
            <Client3DWrapper enable3DHover={user?.profile?.parallax_effect} layoutMaxWidth={layoutMaxWidth}>
                ...
                >
                        ...
                        <div>
                            <div className={`flex items-start gap-6`}>
                                ...
                                {user.badges && user.badges.length > 0 && user.badges.some((badge: any) => !badge.hidden) && (
                                    <div
                                        className="flex justify-center items-center px-[8px] py-[4px] rounded-[17px] bg-white/10 overflow-visible"
                                        style={{
                    ...
                    >
                        ...
                        {/* Divider after views if either location or occupation exists */}
                        {!user.profile?.hide_views_count && (user.profile.location || user.profile.occupation) && (
                            <div
                        ...
                        {/* Divider between location and occupation */}
                        {user.profile.location && user.profile.occupation && (
                            <div
                                className="h-4 w-[1.5px] ml-2 mr-1.5"
                                style={{
                                    backgroundColor: `${user.profile?.text_color}44`
