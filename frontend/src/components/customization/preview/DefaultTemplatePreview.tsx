...
const DefaultTemplatePreview: React.FC<DefaultTemplateProps> = ({ user, layoutMaxWidth, socialIcons, getColorFromIcon, formatJoinedAt, getEffectClass, sortedWidgets, previewTemplate }) => {
